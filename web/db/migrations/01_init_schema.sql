...
CREATE POLICY "Allow public read access on quests" ON quests FOR SELECT USING (true);
CREATE POLICY "Allow public read access on points_events" ON points_events FOR SELECT USING (true);
CREATE POLICY "Allow public read access on markets" ON markets FOR SELECT USING (true);
CREATE POLICY "Allow public read access on bets" ON bets FOR SELECT USING (true);
