...
-- 1.2 Insert Base Creator Profiles (#1 s/d #8)
...
-- 1.3 Insert Base Social Beliefs (#1 s/d #8)
...
-- 1.4 Insert Base Markets (#1 s/d #8)
INSERT INTO markets (
  id,
  belief_id,
  contract_address,
...
VALUES
  ('f0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', '0x1234567890123456789012345678901234567890', 11155111, 1, 'SOL will outperform ETH this month', 'Resolves AGREE if SOL 30-day return exceeds ETH return at settlement timestamp, as reported by Chainlink price feeds.', 'eth', 87.50, 34.00, 87.50, 34.00, now() - interval '2 days', now() + interval '12 days', now() + interval '12 days', 'RELATIVE_PERFORMANCE', '{"assetA": "SOL/USD", "assetB": "ETH/USD"}'::jsonb, 'chainlink', 'OPEN', now() - interval '2 days'),
  ('f0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', '0x1234567890123456789012345678901234567890', 11155111, 2, 'ETH closes above $5,000 before year end', 'Resolves AGREE if ETH/USD spot price reaches or exceeds $5,000.00 before December 31, 2026 23:59:59 UTC.', 'eth', 41.20, 59.80, 41.20, 59.80, now() - interval '3 days', now() + interval '85 days', now() + interval '85 days', 'PRICE_ABOVE', '{"asset": "ETH/USD", "targetPrice": 5000}'::jsonb, 'chainlink', 'OPEN', now() - interval '3 days'),
  ('f0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000003', '0x1234567890123456789012345678901234567890', 11155111, 3, 'BTC prints a new all-time high in Q4', 'Resolves AGREE if BTC/USD spot exceeds previous all-time high ($108,000) during Q4 2026.', 'btc', 63.00, 37.00, 63.00, 37.00, now() - interval '4 days', now() + interval '68 days', now() + interval '68 days', 'PRICE_ABOVE', '{"asset": "BTC/USD", "targetPrice": 108000}'::jsonb, 'chainlink', 'OPEN', now() - interval '4 days'),
  ('f0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000004', '0x1234567890123456789012345678901234567890', 11155111, 4, 'US Bitcoin Strategic Reserve legislation passes this session', 'Resolves AGREE if official US government enacted legislation formally establishing a national Bitcoin strategic reserve is signed into law.', 'btc', 52.40, 47.60, 52.40, 47.60, now() - interval '5 days', now() + interval '45 days', now() + interval '45 days', 'PRICE_ABOVE', '{"asset": "BTC_RESERVE_ENACTED", "oracle": "congress.gov"}'::jsonb, 'chainlink', 'OPEN', now() - interval '5 days'),
  ('f0000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000005', '0x1234567890123456789012345678901234567890', 11155111, 5, 'Arbitrum TVL doubles following Stylus ecosystem deployment', 'Resolves AGREE if DefiLlama verified Arbitrum One Total Value Locked exceeds 2x the baseline level at market creation.', 'arb', 78.00, 22.00, 78.00, 22.00, now() - interval '6 days', now() + interval '90 days', now() + interval '90 days', 'PRICE_ABOVE', '{"asset": "ARB_TVL_2X", "oracle": "defillama"}'::jsonb, 'chainlink', 'OPEN', now() - interval '6 days'),
  ('f0000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000006', '0x1234567890123456789012345678901234567890', 11155111, 6, 'Arbitrum Orbit ecosystem reaches 100 live chains by Q4', 'Resolves AGREE if official Arbitrum Foundation dashboard counts 100 or more live L3/Orbit chains with active sequencer blocks.', 'arb', 45.00, 55.00, 45.00, 55.00, now() - interval '7 days', now() + interval '60 days', now() + interval '60 days', 'PRICE_ABOVE', '{"asset": "ARB_ORBIT_CHAINS_100", "oracle": "arbitrum.io"}'::jsonb, 'chainlink', 'OPEN', now() - interval '7 days'),
  ('f0000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000007', '0x1234567890123456789012345678901234567890', 11155111, 7, 'The Federal Reserve cuts interest rates at the next FOMC meeting', 'Resolves AGREE if the Federal Open Market Committee officially lowers the Fed Funds target rate by at least 25 basis points at the conclusion of the upcoming meeting.', 'macro', 60.50, 40.00, 60.50, 40.00, now() - interval '8 days', now() + interval '22 days', now() + interval '22 days', 'PRICE_BELOW', '{"asset": "FED_FUNDS_RATE", "oracle": "federalreserve.gov"}'::jsonb, 'chainlink', 'OPEN', now() - interval '8 days'),
  ('f0000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000008', '0x1234567890123456789012345678901234567890', 11155111, 8, 'Core US CPI year-over-year prints below 2.5% in next release', 'Resolves AGREE if the US Bureau of Labor Statistics prints Core CPI YoY below 2.50% in the upcoming official monthly release.', 'macro', 68.00, 32.00, 68.00, 32.00, now() - interval '9 days', now() + interval '16 days', now() + interval '16 days', 'PRICE_BELOW', '{"asset": "US_CORE_CPI", "target": 2.5}'::jsonb, 'chainlink', 'OPEN', now() - interval '9 days')
ON CONFLICT (id) DO UPDATE SET
...
-- 1.5 Insert Base Participant Market Positions
...
-- ============================================================
-- SECTION 2: NEW EXPANSION SEED DATA (BATCH 2: MARKETS #9 - #24)
-- ============================================================

-- 2.1 Insert New Creator Users (#9 s/d #12)
INSERT INTO users (id, wallet_address, created_at)
VALUES 
...
-- 2.2 Insert New Creator Profiles (#9 s/d #12)
INSERT INTO creator_profiles (id, wallet_address, handle, confirmed_beliefs_count, resolved_count, correct_count, created_at)
VALUES
...
-- 2.3 Insert New Social Beliefs (#9 s/d #24)
INSERT INTO beliefs (id, author, statement, source_url, source_platform, source_timestamp, ai_confidence, status, created_at)
VALUES
...
-- 2.4 Insert New On-Chain Social Belief Markets (#9 s/d #24)
INSERT INTO markets (
  id,
  belief_id,
  contract_address,
...
VALUES
  ('f0000000-0000-0000-0000-000000000009', 'b0000000-0000-0000-0000-000000000009', '0x4663100000000000000000000000000000004663', 46631, 9, 'Uniswap v4 hooks process over $10B monthly volume', 'Resolves AGREE if DefiLlama verifies total v4 pool monthly trading volume reaches or exceeds $10 Billion.', 'crypto', 55.20, 38.40, 55.20, 38.40, now() - interval '10 days', now() + interval '50 days', now() + interval '50 days', 'PRICE_ABOVE', '{"asset": "UNI_V4_VOL_10B"}'::jsonb, 'chainlink', 'OPEN', now() - interval '10 days'),
  ('f0000000-0000-0000-0000-000000000010', 'b0000000-0000-0000-0000-000000000010', '0x1234567890123456789012345678901234567890', 11155111, 10, 'Ethereum Layer 1 gas fees remain sub-10 gwei after blob scaling upgrade', 'Resolves AGREE if median 7-day Ethereum base fee remains under 10 gwei as reported by Etherscan gas trackers.', 'eth', 72.80, 27.20, 72.80, 27.20, now() - interval '11 days', now() + interval '35 days', now() + interval '35 days', 'PRICE_BELOW', '{"asset": "ETH_GAS_MEDIAN", "target": 10}'::jsonb, 'chainlink', 'OPEN', now() - interval '11 days'),
  ('f0000000-0000-0000-0000-000000000011', 'b0000000-0000-0000-0000-000000000011', '0x4663100000000000000000000000000000004663', 46631, 11, 'Autonomous AI agents execute over 1M on-chain transactions daily', 'Resolves AGREE if combined Artemis/Dune analytics show verified autonomous agent wallets submitting over 1M txs in 24 hours.', 'ai', 64.00, 46.00, 64.00, 46.00, now() - interval '12 days', now() + interval '75 days', now() + interval '75 days', 'PRICE_ABOVE', '{"asset": "AGENT_TX_1M"}'::jsonb, 'chainlink', 'OPEN', now() - interval '12 days'),
  ('f0000000-0000-0000-0000-000000000012', 'b0000000-0000-0000-0000-000000000012', '0x1234567890123456789012345678901234567890', 11155111, 12, 'Base daily active users surpass Arbitrum One by Q4', 'Resolves AGREE if 30-day moving average of daily active addresses on Base flips Arbitrum One.', 'arb', 38.50, 61.50, 38.50, 61.50, now() - interval '13 days', now() + interval '42 days', now() + interval '42 days', 'RELATIVE_PERFORMANCE', '{"assetA": "BASE_DAU", "assetB": "ARB_DAU"}'::jsonb, 'chainlink', 'OPEN', now() - interval '13 days'),
  ('f0000000-0000-0000-0000-000000000013', 'b0000000-0000-0000-0000-000000000013', '0x1234567890123456789012345678901234567890', 11155111, 13, 'ETH/BTC ratio bottoms and breaks above 0.06', 'Resolves AGREE if ETH/BTC price ratio trades at or above 0.0600 on Binance/Coinbase feeds.', 'eth', 49.00, 51.00, 49.00, 51.00, now() - interval '14 days', now() + interval '30 days', now() + interval '30 days', 'PRICE_ABOVE', '{"asset": "ETH/BTC", "targetPrice": 0.06}'::jsonb, 'chainlink', 'OPEN', now() - interval '14 days'),
  ('f0000000-0000-0000-0000-000000000014', 'b0000000-0000-0000-0000-000000000014', '0x1234567890123456789012345678901234567890', 11155111, 14, 'US 10-Year Treasury Yield falls below 3.75%', 'Resolves AGREE if US 10-Year Treasury benchmark yield prints below 3.75% at market close.', 'macro', 57.30, 42.70, 57.30, 42.70, now() - interval '15 days', now() + interval '28 days', now() + interval '28 days', 'PRICE_BELOW', '{"asset": "US10Y", "target": 3.75}'::jsonb, 'chainlink', 'OPEN', now() - interval '15 days'),
  ('f0000000-0000-0000-0000-000000000015', 'b0000000-0000-0000-0000-000000000015', '0x1234567890123456789012345678901234567890', 11155111, 15, 'Total stablecoin market cap prints a new record above $180B', 'Resolves AGREE if DefiLlama aggregate stablecoin market capitalization crosses $180 Billion USD.', 'crypto', 82.00, 18.00, 82.00, 18.00, now() - interval '16 days', now() + interval '65 days', now() + interval '65 days', 'PRICE_ABOVE', '{"asset": "STABLE_MCAP_180B"}'::jsonb, 'chainlink', 'OPEN', now() - interval '16 days'),
  ('f0000000-0000-0000-0000-000000000016', 'b0000000-0000-0000-0000-000000000016', '0x1234567890123456789012345678901234567890', 11155111, 16, 'Bitcoin dominance tops out below 62% during the current cycle', 'Resolves AGREE if TradingView BTC.D index fails to exceed 62.00% before market settlement.', 'btc', 44.10, 55.90, 44.10, 55.90, now() - interval '17 days', now() + interval '80 days', now() + interval '80 days', 'PRICE_BELOW', '{"asset": "BTC_DOMINANCE", "target": 62}'::jsonb, 'chainlink', 'OPEN', now() - interval '17 days'),
  ('f0000000-0000-0000-0000-000000000017', 'b0000000-0000-0000-0000-000000000017', '0x1234567890123456789012345678901234567890', 11155111, 17, 'Arbitrum BOLD permissionless validation goes live on mainnet', 'Resolves AGREE if Arbitrum DAO officially verifies BOLD validation live on Arbitrum One mainnet.', 'arb', 91.50, 18.50, 91.50, 18.50, now() - interval '18 days', now() + interval '38 days', now() + interval '38 days', 'PRICE_ABOVE', '{"asset": "ARB_BOLD_LIVE"}'::jsonb, 'chainlink', 'OPEN', now() - interval '18 days'),
  ('f0000000-0000-0000-0000-000000000018', 'b0000000-0000-0000-0000-000000000018', '0x4663100000000000000000000000000000004663', 46631, 18, 'Stylus contracts exceed 500 verified deployments', 'Resolves AGREE if Arbiscan reports 500+ verified Rust/C/C++ Stylus smart contract deployments.', 'arb', 53.00, 47.00, 53.00, 47.00, now() - interval '19 days', now() + interval '55 days', now() + interval '55 days', 'PRICE_ABOVE', '{"asset": "STYLUS_500_CONTRACTS"}'::jsonb, 'chainlink', 'OPEN', now() - interval '19 days'),
  ('f0000000-0000-0000-0000-000000000019', 'b0000000-0000-0000-0000-000000000019', '0x1234567890123456789012345678901234567890', 11155111, 19, 'ECB cuts deposit facility rate by 50bps before Q4', 'Resolves AGREE if the European Central Bank announces a 50 basis point reduction to the deposit facility rate.', 'macro', 40.00, 60.00, 40.00, 60.00, now() - interval '20 days', now() + interval '25 days', now() + interval '25 days', 'PRICE_BELOW', '{"asset": "ECB_RATE", "target": 50}'::jsonb, 'chainlink', 'OPEN', now() - interval '20 days'),
  ('f0000000-0000-0000-0000-000000000020', 'b0000000-0000-0000-0000-000000000020', '0x1234567890123456789012345678901234567890', 11155111, 20, 'Global central bank gold reserves reach new historical high', 'Resolves AGREE if World Gold Council quarterly report shows net central bank gold purchases at record levels.', 'macro', 76.50, 23.50, 76.50, 23.50, now() - interval '21 days', now() + interval '70 days', now() + interval '70 days', 'PRICE_ABOVE', '{"asset": "CENTRAL_BANK_GOLD"}'::jsonb, 'chainlink', 'OPEN', now() - interval '21 days'),
  ('f0000000-0000-0000-0000-000000000021', 'b0000000-0000-0000-0000-000000000021', '0x1234567890123456789012345678901234567890', 11155111, 21, 'Liquid restaking protocol TVL exceeds $20 Billion', 'Resolves AGREE if total LRT TVL (ether.fi, Renzo, Puffer) exceeds $20B on DefiLlama.', 'crypto', 62.40, 37.60, 62.40, 37.60, now() - interval '22 days', now() + interval '48 days', now() + interval '48 days', 'PRICE_ABOVE', '{"asset": "LRT_TVL_20B"}'::jsonb, 'chainlink', 'OPEN', now() - interval '22 days'),
  ('f0000000-0000-0000-0000-000000000022', 'b0000000-0000-0000-0000-000000000022', '0x1234567890123456789012345678901234567890', 11155111, 22, 'Account Abstraction ERC-4337 smart accounts exceed 10M active users', 'Resolves AGREE if Dune Analytics verified ERC-4337 account abstraction wallets cross 10 Million on L1 & L2s.', 'eth', 85.00, 15.00, 85.00, 15.00, now() - interval '23 days', now() + interval '62 days', now() + interval '62 days', 'PRICE_ABOVE', '{"asset": "ERC4337_10M_USERS"}'::jsonb, 'chainlink', 'OPEN', now() - interval '23 days'),
  ('f0000000-0000-0000-0000-000000000023', 'b0000000-0000-0000-0000-000000000023', '0x4663100000000000000000000000000000004663', 46631, 23, 'Open source AI model weights surpass proprietary LLMs on coding benchmarks', 'Resolves AGREE if an open-weights model achieves #1 on LMSYS Chatbot Arena coding leaderboard.', 'ai', 70.00, 30.00, 70.00, 30.00, now() - interval '24 days', now() + interval '40 days', now() + interval '40 days', 'PRICE_ABOVE', '{"asset": "OPEN_LLM_LEADER"}'::jsonb, 'chainlink', 'OPEN', now() - interval '24 days'),
  ('f0000000-0000-0000-0000-000000000024', 'b0000000-0000-0000-0000-000000000024', '0x1234567890123456789012345678901234567890', 11155111, 24, 'Ethereum ETF net inflows cross $15 Billion in 2026', 'Resolves AGREE if Farside Investors / Bloomberg terminal data shows cumulative US Spot Ethereum ETF net inflows exceed $15 Billion.', 'eth', 66.80, 33.20, 66.80, 33.20, now() - interval '25 days', now() + interval '95 days', now() + interval '95 days', 'PRICE_ABOVE', '{"asset": "ETH_ETF_INFLOWS_15B"}'::jsonb, 'chainlink', 'OPEN', now() - interval '25 days')
ON CONFLICT (id) DO UPDATE SET
  title = EXCLUDED.title,
  category = EXCLUDED.category,
  agree_pool = EXCLUDED.agree_pool,
