          ...
          if (isMounted && Array.isArray(creatorList)) {
            const mapped: CreatorProfile[] = creatorList
              ...
              .map((c: any) => ({
                ...
                accuracyRate: Number(c.accuracyRate ?? c.accuracy_rate ?? c.accuracy_percentage ?? c.win_rate ?? 0),
                confirmedBeliefs: Number(c.confirmedBeliefs ?? c.confirmed_count ?? c.confirmed_beliefs_count ?? 0),
                totalBeliefs: Number(c.totalBeliefs ?? c.total_count ?? c.total_beliefs_count ?? 0),
