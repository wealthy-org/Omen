...
function mapToMarketDetailData(raw: Record<string, unknown>, idFallback: string): MarketDetailData {
  ...
  return {
    ...
    authorHandle: typeof raw.authorHandle === "string" ? raw.authorHandle : "",
    creatorAddress: typeof raw.creatorAddress === "string" ? raw.creatorAddress : "",
    ...
    winningSide: raw.winningSide ? (raw.winningSide as "AGREE" | "DISAGREE") : undefined,
    ...
    marketAddress: typeof raw.marketAddress === "string" ? raw.marketAddress : "",
    chainId: typeof raw.chainId === "number" ? raw.chainId : 11155111,
    oracleFeed: typeof raw.oracleFeed === "string" ? raw.oracleFeed : "",
    targetPrice: typeof raw.targetPrice === "number" ? raw.targetPrice : 0,
    resolutionType: typeof raw.resolutionType === "string" ? raw.resolutionType : "PRICE_ABOVE",
  };
}
