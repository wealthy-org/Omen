...
export const BettingModal: React.FC<BettingModalProps> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 bg-black/40 dark:bg-black/75 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto"
      onClick={(e) => {
    ...
    >
      <div
        ...
        className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl max-w-lg w-full p-6 sm:p-8 shadow-2xl relative text-zinc-900 dark:text-zinc-100 animate-in fade-in zoom-in-95 duration-200"
      >
        <button
          type="button"
          onClick={onClose}
        ...
        <h2 id="betting-modal-title" className="text-lg sm:text-xl font-bold leading-snug mb-5 text-zinc-900 dark:text-zinc-100">
          {market.title}
        </h2>
        ...
        <form onSubmit={handleConfirm} className="space-y-5">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 p-1 bg-zinc-100 dark:bg-zinc-800/80 rounded-xl border border-zinc-200 dark:border-zinc-700/60">
              <button
                ...
                className={`py-3 px-4 rounded-lg font-bold text-sm transition-all flex items-center justify-between ${
                  selectedOutcome === "YES"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                className="w-full pl-4 pr-16 py-3.5 bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 rounded-xl text-2xl font-bold font-mono text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
          ...
          <div className="bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 space-y-2 text-xs">
